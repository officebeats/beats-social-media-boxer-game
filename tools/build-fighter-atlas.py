...
def draw_ab(ox=0):
    ...
    poly(offset([(12, 36), (17, 37), (14, 43), (11, 47), (8, 52),
                 (3, 52), (6, 45), (8, 40)], ox), 0)
    poly(offset([(12, 38), (16, 38), (15, 41), (12, 44), (11, 46),
                 (7, 51), (5, 50), (8, 44), (9, 40)], ox), 4)
    line(ox + 13, 39, ox + 10, 45, 9)
    rect(ox + 9, 44, ox + 11, 45, 4)
    pset(ox + 9, 45, 5)
    pset(ox + 11, 44, 9)
    ...
    poly(offset([(10, 28), (29, 28), (30, 31), (27, 40), (22, 40),
                 (19, 35), (16, 40), (9, 40), (9, 31)], ox), 0)
    poly(offset([(12, 30), (27, 30), (28, 32), (25, 38), (22, 38),
                 (19, 33), (16, 38), (11, 38)], ox), 2)
    line(ox + 11, 29, ox + 27, 29, 13)
    rect(ox + 18, 29, ox + 20, 30, 5)
    line(ox + 11, 32, ox + 11, 37, 7)
    line(ox + 27, 32, ox + 25, 37, 7)
    line(ox + 19, 34, ox + 19, 39, 0)
    line(ox + 12, 33, ox + 12, 37, 13)
    ...
    poly(offset([(8, 32), (7, 25), (9, 20), (14, 17), (19, 14),
                 (27, 15), (33, 19), (35, 25), (32, 32)], ox), 0)
    poly(offset([(11, 31), (10, 24), (14, 20), (20, 16), (26, 17),
                 (31, 21), (32, 27), (29, 31)], ox), 1)
    poly(offset([(10, 21), (14, 18), (17, 20), (16, 25), (12, 27), (9, 24)], ox), 1)
    poly(offset([(27, 17), (32, 20), (34, 25), (31, 27), (27, 23)], ox), 1)
    line(ox + 10, 22, ox + 14, 25, 5)
...
def draw_dg(ox=40):
    poly(offset([(12, 36), (17, 37), (14, 43), (10, 47), (7, 52),
                 (2, 52), (5, 45), (8, 40)], ox), 0)
    poly(offset([(12, 38), (16, 38), (15, 41), (12, 44), (10, 46),
                 (6, 51), (4, 50), (7, 44), (9, 40)], ox), 4)
    line(ox + 13, 39, ox + 9, 45, 9)
    rect(ox + 8, 44, ox + 10, 45, 4)
    pset(ox + 8, 45, 5)
    pset(ox + 10, 44, 9)
    ...
    poly(offset([(10, 28), (30, 28), (31, 31), (27, 40), (22, 40),
                 (19, 35), (16, 40), (9, 40), (9, 31)], ox), 0)
    poly(offset([(12, 30), (28, 30), (29, 32), (25, 38), (22, 38),
                 (19, 33), (16, 38), (11, 38)], ox), 3)
    line(ox + 11, 29, ox + 28, 29, 10)
    rect(ox + 19, 29, ox + 21, 30, 9)
    line(ox + 11, 32, ox + 11, 37, 10)
    line(ox + 28, 32, ox + 25, 37, 10)
    line(ox + 19, 34, ox + 19, 39, 0)
    line(ox + 12, 33, ox + 12, 37, 10)
    ...
    poly(offset([(8, 32), (7, 25), (9, 20), (14, 17), (19, 14),
                 (27, 15), (33, 19), (35, 25), (32, 32)], ox), 0)
    poly(offset([(11, 31), (10, 24), (14, 20), (20, 16), (26, 17),
                 (31, 21), (32, 27), (29, 31)], ox), 4)
    poly(offset([(10, 21), (14, 18), (17, 19), (16, 23), (12, 25), (9, 23)], ox), 4)
...
def draw_step(ox, oy, trunks, trim, boot, sock, hi):
    poly(offset([(9, 0), (30, 0), (30, 4), (26, 9), (22, 9),
                 (19, 6), (16, 10), (9, 9)], ox, oy), 0)
    poly(offset([(11, 1), (28, 1), (27, 4), (24, 8), (22, 7),
                 (19, 5), (16, 8), (11, 7)], ox, oy), trunks)
...
def draw_step2(ox, oy, trunks, trim, boot, sock, hi):
    poly(offset([(9, 0), (30, 0), (29, 4), (25, 9), (21, 8),
                 (18, 6), (15, 10), (9, 8)], ox, oy), 0)
    poly(offset([(11, 1), (28, 1), (26, 4), (23, 7), (21, 7),
                 (18, 4), (15, 8), (11, 6)], ox, oy), trunks)
    rect(ox + 10, oy + 1, ox + 28, oy + 3, trim)
    line(ox + 15, oy + 8, ox + 10, oy + 17, 0, 7)
