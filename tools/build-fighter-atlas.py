...
def draw_ab(ox=0):
    ...
    poly(offset([(8, 28), (29, 28), (31, 32), (28, 40), (22, 40), (19, 37), (15, 41), (8, 39)], ox), 0)
    poly(offset([(10, 29), (27, 29), (28, 32), (26, 38), (22, 38), (19, 35), (15, 39), (10, 37)], ox), 2)
    rect(ox + 10, 29, ox + 28, 31, 13)
    rect(ox + 12, 30, ox + 26, 31, 5)
    line(ox + 11, 37, ox + 15, 38, 7)
    line(ox + 26, 32, ox + 25, 38, 7)
...
def draw_dg(ox=40):
    ...
    poly(offset([(8, 28), (30, 28), (32, 32), (28, 41), (22, 40), (19, 37), (15, 41), (8, 39)], ox), 0)
    poly(offset([(10, 29), (28, 29), (29, 32), (26, 39), (22, 38), (19, 35), (15, 39), (10, 37)], ox), 3)
    rect(ox + 10, 29, ox + 29, 31, 10)
    rect(ox + 14, 30, ox + 25, 31, 9)
    line(ox + 11, 37, ox + 15, 38, 10)
    line(ox + 27, 32, ox + 25, 38, 10)
    pset(ox + 18, 33, 11)
    pset(ox + 21, 36, 11)
    pset(ox + 24, 33, 11)
