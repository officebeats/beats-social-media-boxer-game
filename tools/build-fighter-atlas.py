...
def draw_ab(ox=0):
    ...
    line(ox + 12, 33, ox + 11, 39, 13)
    line(ox + 26, 33, ox + 25, 39, 5)
    line(ox + 12, 40, ox + 16, 42, 5)
    line(ox + 22, 41, ox + 26, 39, 13)
    pset(ox + 17, 31, 7)
    pset(ox + 21, 31, 6)
    pset(ox + 15, 42, 13)
    pset(ox + 23, 41, 13)

    poly(offset([(6, 32), (5, 25), (7, 19), (13, 16), (18, 14),
                 (28, 15), (34, 19), (37, 25), (35, 32)], ox), 0)
    poly(offset([(9, 31), (8, 23), (13, 19), (19, 16), (27, 17),
                 (32, 20), (34, 27), (32, 31)], ox), 1)
    poly(offset([(8, 20), (13, 17), (16, 20), (15, 26), (10, 27), (7, 24)], ox), 1)
    poly(offset([(28, 17), (34, 20), (36, 25), (32, 27), (28, 23)], ox), 1)
    line(ox + 10, 22, ox + 14, 25, 5)
    line(ox + 31, 21, ox + 33, 25, 5)
    line(ox + 14, 29, ox + 29, 29, 5)
    line(ox + 17, 31, ox + 26, 31, 6)
    pset(ox + 12, 20, 6)
    pset(ox + 29, 19, 6)
...
def draw_dg(ox=40):
    ...
    line(ox + 12, 33, ox + 11, 39, 10)
    line(ox + 27, 33, ox + 25, 40, 5)
    line(ox + 12, 40, ox + 16, 42, 5)
    line(ox + 23, 41, ox + 27, 39, 10)
    pset(ox + 17, 31, 15)
    pset(ox + 22, 31, 9)
    pset(ox + 15, 42, 11)
    pset(ox + 23, 42, 11)

    poly(offset([(5, 32), (5, 24), (7, 19), (13, 16), (18, 14),
                 (28, 15), (35, 19), (37, 25), (35, 32)], ox), 0)
    poly(offset([(8, 31), (8, 23), (13, 19), (19, 16), (27, 17),
                 (33, 21), (34, 27), (32, 31)], ox), 4)
    poly(offset([(8, 20), (13, 17), (17, 19), (15, 23), (10, 25), (7, 23)], ox), 4)
    poly(offset([(27, 17), (34, 20), (36, 24), (33, 26), (28, 23)], ox), 4)
    line(ox + 13, 20, ox + 18, 22, 9)
    line(ox + 22, 22, ox + 29, 20, 9)
    line(ox + 15, 23, ox + 29, 23, 0)
