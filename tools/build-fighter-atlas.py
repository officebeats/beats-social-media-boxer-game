...
def draw_ab(ox=0):
    ...
    rect(ox + 18, 13, ox + 24, 18, 0)
    rect(ox + 19, 12, ox + 23, 17, 4)
    poly(offset([(15, 5), (18, 2), (25, 2), (28, 4), (29, 7), (31, 9), (31, 12), (29, 13), (28, 16), (25, 18), (19, 18), (16, 16), (14, 12), (14, 7)], ox), 0)
    poly(offset([(17, 6), (19, 4), (24, 4), (27, 5), (27, 8), (30, 9), (29, 11), (27, 11), (26, 15), (23, 16), (19, 15), (16, 12), (16, 8)], ox), 4)
    poly(offset([(15, 4), (18, 2), (25, 2), (28, 4), (27, 6), (24, 5), (20, 5), (17, 7), (15, 7)], ox), 0)
    pset(ox + 18, 3, 5)
    pset(ox + 20, 3, 5)
    pset(ox + 22, 3, 5)
    pset(ox + 24, 3, 5)
    ...
    pset(ox + 25, 4, 5)
    pset(ox + 27, 5, 5)
    poly(offset([(16, 11), (19, 11), (21, 13), (24, 12), (29, 11), (29, 15), (26, 18), (23, 19), (18, 17)], ox), 0)
    line(ox + 19, 13, ox + 20, 16, 5)
    pset(ox + 22, 17, 5)
    pset(ox + 25, 16, 5)
    pset(ox + 27, 14, 5)
    line(ox + 20, 17, ox + 24, 18, 5)
    pset(ox + 16, 9, 9)
    pset(ox + 17, 10, 15)
    pset(ox + 19, 7, 9)
    pset(ox + 20, 6, 15)
    line(ox + 23, 6, ox + 27, 6, 0)
    pset(ox + 25, 7, 7)
    pset(ox + 27, 7, 0)
    pset(ox + 28, 8, 9)
    pset(ox + 30, 10, 15)
    pset(ox + 29, 11, 9)
    line(ox + 25, 13, ox + 28, 13, 4)
    pset(ox + 27, 13, 15)
...
def draw_dg(ox=40):
    ...
    rect(ox + 18, 13, ox + 24, 18, 0)
    rect(ox + 19, 12, ox + 23, 17, 4)
    poly(offset([(15, 5), (18, 2), (25, 2), (28, 4), (29, 8), (31, 10), (30, 12), (28, 13), (27, 16), (24, 18), (19, 17), (16, 14), (14, 11), (14, 7)], ox), 0)
    poly(offset([(17, 6), (19, 4), (24, 4), (27, 5), (27, 9), (29, 10), (28, 12), (26, 12), (25, 15), (22, 16), (19, 15), (16, 12), (16, 8)], ox), 4)
    poly(offset([(15, 4), (18, 2), (25, 2), (28, 4), (27, 6), (24, 5), (21, 5), (18, 6), (15, 7)], ox), 0)
    line(ox + 18, 2, ox + 8, 13, 0, 2)
    line(ox + 21, 2, ox + 12, 15, 0, 2)
    line(ox + 24, 2, ox + 17, 16, 0, 2)
    line(ox + 27, 3, ox + 22, 17, 0, 2)
    pset(ox + 8, 12, 5)
    pset(ox + 12, 13, 5)
    pset(ox + 16, 13, 5)
    pset(ox + 21, 14, 5)
